...
namespace ApplicationCore.Services.Repository.AutoServiceRepository
{
    public class AutoServiceRepository<TEntity> : IAutoServiceRepository<TEntity> where TEntity : BaseEntity
    {
        protected readonly AutoServiceDbContext _dbContext;
        private readonly IMapper _mapper;

        public AutoServiceRepository(AutoServiceDbContext dbContext, IMapper mapper)
        {
